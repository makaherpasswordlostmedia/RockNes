...
/* Lowered from upstream's 48000 for the iPod Mini 2G's 11MHz ARM7TDMI -
 * 11025 Hz matches Rockbox's SAMPR_11 and keeps APU mixing cheap enough
 * to leave headroom for CPU/PPU emulation each frame. */
